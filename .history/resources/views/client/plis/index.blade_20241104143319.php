...
<div class="container-fluid px-4">
    ...
    <div class="mb-3" style="max-width: 500px; margin-top: 10px">
        <div class="input-group">
            <input type="text" id="searchInput" class="form-control" placeholder="Rechercher un plis..." aria-label="Rechercher un destinataire..." />
        ...
        <table class="table table-striped table-bordered mt-3">
            <thead class="table-light">
                <tr>
                    ...
                    <th scope="col" class="text-nowrap">Code de suivis</th>
