...
{
    $users = User::paginate(10000); // Paginer les utilisateurs par 10
    $destinataires = Destinataire::paginate(10000); // Paginer les destinataires par 10
    $plis = Pli::paginate(10000); // Paginer les plis par 10
    $coursiers = Coursier::paginate(10000); // Paginer les coursiers par 10
