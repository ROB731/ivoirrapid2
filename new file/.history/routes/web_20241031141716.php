...
Route::prefix('admin')->middleware(['auth', 'isAdmin'])->group(function () {
    ...
    Route::get('add-destinataire', [DestinataireController::class, 'create'])->name('admin.add-destinataire');
    Route::post('add-destinataire', [DestinataireController::class, 'store'])->name('admin.store-destinataire');
});
