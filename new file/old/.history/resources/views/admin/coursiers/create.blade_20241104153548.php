        ...
        <div class="col-md-8">
            ...
            <form action="{{ url('client/add-coursier') }}" method="POST" class="mt-5 bg-light p-5 rounded shadow" enctype="multipart/form-data" id="clientForm">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control bg-primary text-white @error('contact_urgence') is-invalid @enderror" id="contact_urgence" name="adresse" required value="{{ old('adresse') }}">
