...
@section('title', 'IvoirRp - Admin Coursiers')
...
<div class="container-fluid px-4 my-3">
    ...
    <div class="mb-3" style="max-width: 500px; margin-top: 10px">
        <div class="input-group">
            <input type="text" id="searchInput" class="form-control" placeholder="Rechercher un coursier..." aria-label="Rechercher un destinataire..." />
