        ...
        <table class="table table-striped table-bordered mt-3">
            <thead class="table-light">
                <tr>
                    ...
                    <th>Email</th>
                    <th>Code</th>
                    <th class="text-nowrap">Numéro de Permis</th>
                    <th class="text-nowrap">Date de Validité du Permis</th>
                    <th class="text-nowrap">Catégorie du Permis</th>
                    <th class="text-nowrap">Numéro de CNI</th>
                    <th class="text-nowrap">Date de Validité de la CNI</th>
                    <th class="text-nowrap">Numéro de la CMU</th>
                    <th class="text-nowrap">Date de Validité de la CMU</th>
                    <th class="text-nowrap">Date de Naissance</th>
                    <th class="text-nowrap">Groupe Sanguin</th>
                    <th class="text-nowrap">Date de Début du Contrat</th>
                    <th class="text-nowrap">Date de Fin du Contrat</th>
                    <th class="text-nowrap">Adresse</th>
                    <th class="text-nowrap">Contact d'Urgence</th>
                    <th class="text-nowrap">Affiliation d'Urgence</th>
