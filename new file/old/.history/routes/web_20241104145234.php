...
Route::prefix('admin')->middleware(['auth', 'isAdmin'])->group(function () {
    ...
    Route::get('coursiers', [App\Http\Controllers\Admin\CoursierController::class, 'index']);
    Route::get('add-coursier', [App\Http\CoControllers\Admin\CoursierController::class, 'create']);
});
