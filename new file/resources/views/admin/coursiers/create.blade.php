...
@section('title', 'IvoirRp - Ajouter un Coursier')
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            @endif
            <form action="{{ url('admin/add-coursier') }}" method="POST" class="mt-5 bg-light p-5 rounded shadow" enctype="multipart/form-data" id="clientForm">
                @csrf
                @if ($errors->has('zones'))
    <div class="alert alert-danger">
...
@if ($errors->has('zones.*'))
    <div class="alert alert-danger">
        @foreach ($errors->get('zones.*') as $messages)
...
@endif
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control bg-primary text-white @error('zone_count') is-invalid @enderror" id="zone-count" name="zone_count" min="1" required value="{{ old('zone_count') }}">
                    @error('zone_count')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control bg-primary text-white @error('contact_urgence') is-invalid @enderror" id="contact_urgence" name="contact_urgence" required value="{{ old('contact_urgence') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control bg-primary text-white @error('affiliation_urgence') is-invalid @enderror" id="affiliation_urgence" name="affiliation_urgence" required value="{{ old('affiliation_urgence') }}">
