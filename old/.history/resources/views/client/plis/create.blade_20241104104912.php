        ...
        <div class="col-md-8">
            ...
            <form action="{{ url('client/add-pli') }}" method="POST" class="mt-5 bg-light p-5 rounded shadow" enctype="multipart/form-data" id="pliForm">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control bg-primary text-white @error('nombre_de_pieces') is-invalid @enderror" id="nombre_de_pieces" name="nombre_de_pieces" required oninput="generateReferenceFields()">
                ...
                <div id="referenceFieldsContainer">
                    <label for="reference" class="form-label"></label>
                    <input type="text" class="form-control" id="reference" name="reference" value="{{ $code }}" readonly>
                </div>
...
<script>
    ...
    function generateReferenceFields() {
        const pieceCount = parseInt(document.getElementById('nombre_de_pieces').value) || 0;
