...
<style>
    ...
    <div class="btn-container">
        <div class="form-container my-3 mx-3">
            <form action="{{ route('admin.attributions.depot') }}" method="GET">
...
try {
    ...
    const nomFichier = `plis depot_${coursierNom.replace(/\s+/g, '_')}_${dateString}.pdf`; // Remplacer les espaces par des underscores
