...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            @endif
            <form action="{{ url('client/add-destinataire') }}" method="POST" class="mt-5 bg-light p-5 rounded shadow" enctype="multipart/form-data" id="clientForm">
                @csrf
        <!-- autres Champs -->
                 <!-- Nom destinataire -->
                 <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control bg-primary text-white @error('contact') is-invalid @enderror" id="contact" name="contact" pattern="^\d{10}$" maxlength="10" required value="{{ old('Cellulaire') }}">
                    @error('Cellulaire')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control bg-primary text-white @error('zone') is-invalid @enderror" id="zone" name="zone" required value="000{{ old('zone') }}" readonly>
                    @error('zone')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <!-- autre (Note) -->
                <div class="mb-3">
                    <label for="autre" class="form-label">Autre <span class="text-danger">*</span> </label>
