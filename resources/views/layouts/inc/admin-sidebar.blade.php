            ...
            <div class="nav">
                ...
                <div class="collapse" id="collapseAdmins" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        ...
                        {{-- <a class="nav-link" href="{{ url('admin/plis/verification_depot_pli') }}">Validatiobn de statut de plis</a> --}}

                        {{-- <a href="{{ url('/admin/plis/verification-depot-pli') }}" class="btn btn-primary">Vérifier le statut des plis</a> --}}
                        {{-- <a href="{{ route('verification.depot.pli') }}" class="btn btn-primary">🔍 Vérifier les plis déposés</a> --}}



                        {{-- 01-05-2025---------------------- --}}
                        <a href="{{ route('admin.attributions.index') }}" class="nav-link" title="Attribuer"  style="">
                            <i class="fas fa-user-plus"></i> Attribution des plis
                        </a>

                          <a href="{{ url('admin/plis/verification') }}" class="nav-link" title="Vérifier"  style="">
                                Vérifications plis supprimés
                            </a>


                         {{-- buton pour  01-05-2025---------------------- --}}
                ...
                <div class="collapse" id="collapseReports" aria-labelledby="headingThree" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        ...
                        <a class="nav-link" href="{{ url('admin/add-coursier') }}">Fiche de mission dépot</a>
...
<div>
    ...
    <a href="#" class="btn btn-warning btn-sm">
        <i class="fas fa-pencil-alt"></i> Voir les plis modifiés
    </a>

        <br> <br>
    <a href="{{ route('admin.plis.plis_trashed') }}" class="btn btn-danger btn-sm">
